...
No CQ bag can have this shape: a triple pattern, or a BGP, binds a fixed set of variables, and a \texttt{JOIN} returns only the merges of compatible solution mappings, each over the union of the two input domains, and rejects the rest.
